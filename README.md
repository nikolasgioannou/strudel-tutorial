...
Constraint: **I can't hear audio.** So everything in here is described in terms of what each operator does to the _structure_ of a pattern — its timing, layering, transformation, randomness, harmony — not "how it sounds." That turns out to be the right level anyway, because Strudel patterns are fundamentally structural objects.
